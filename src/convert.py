...
def trans2switch(
    trans_path="./data/pythia2opt-6.7b/glove.json",
    src_clm_path="./data/pythia-1b",
    tgt_clm_path="./data/pythia-1b2opt-6.7b",
    tgt_tok_path="./data/opt-6.7b",
    random_shuffle=-1,
):
    import sys
    sys.stdout.flush()
...
if __name__ == '__main__':
    ...
    parser.add_argument("-t", "--target-tokenizer-path", type=str, default="facebook/opt-6.7b")
    parser.add_argument("-o", "--output-model-path", type=str, default="./data/pythia2opt-6.7b/glove")
