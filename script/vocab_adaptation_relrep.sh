...
export MASTER_PORT=16901  # Different port to avoid conflicts with regular training

export MODEL="1b"

export TGT="opt-6.7b"

# Use relative representation initialized model
MODEL_NAME="./data/pythia2${TGT}/TokAlign-RelRep-Init-1B"
...
# Prefix includes "relrep" to distinguish from regular training
PREFIX="${MODEL}/${SEED}_${TGT}_relrep_S1"
...
printf "\n### STAGE-1: Vocabulary Adaptation with Relative Representations ###\n\n"
printf "Model: ${MODEL_NAME}\n"
printf "Dataset: ${DATASET_PATH}\n"
printf "Output: ${MODEL_DIR}\n\n"
...
STAGE1_CHECKPOINT="${MAIN_DIR}/log/${MODEL}/${SEED}_${TGT}_relrep_S1/checkpoint-${NUM_STEPS}"
...
PREFIX="${MODEL}/${SEED}_${TGT}_relrep_S2"
...
printf "\n### STAGE-2: Full Fine-tuning with Relative Representations ###\n\n"
printf "Starting from checkpoint: ${MODEL_NAME}\n"
printf "Output: ${MODEL_DIR}\n\n"
