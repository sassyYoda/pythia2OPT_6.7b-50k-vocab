...
export MODLE_PATH="./data/pythia2opt-6.7b/TokAlign-Init-1B"
export TOKENIZER_PATH="./data/pythia2opt-6.7b/TokAlign-Init-1B"
...
export DATASET_PATH="./data/pretrain-dataset/pile00-opt-6.7b-tokenized"
# export DATASET_PATH="./data/pretrain-dataset/pile00-sample-opt-6.7b-tokenized"
